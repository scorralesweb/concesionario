<template>
  <NuxtLayout name="camiones">
    <CamionesIntro
      ...
      ctaLink="#contactForm"
      imagenURL="/images/camiones/modelos/axor-todo-terreno/"
    >
    </CamionesIntro>

    <section id="resumen">
      <div class="pageWidth">
        <h3>AXOR, LO FUERTE PUEDE SER MUY FUERTE.</h3>
        <p>El Axor te permite escalar tu capacidad de carga hasta 55,5 tn.</p>
      </div>
    </section>
        ...
        <ul>
          <li>
            <CamionesCardsCaracteristicaCard
              imagen="/images/camiones/modelos/axor-todo-terreno/seguridad.jpg"
              titulo="Seguridad."
              :lista="[
          ...
          <li>
            <CamionesCardsCaracteristicaCard
              imagen="/images/camiones/modelos/axor-todo-terreno/confort.jpg"
              titulo="Confort."
          ...
          <li>
            <CamionesCardsCaracteristicaCard
              imagen="/images/camiones/modelos/axor-todo-terreno/tecnologia.jpg"
              titulo="Tecnología"
              :lista="[
                'Sistema de mantenimiento Telligent: El camión indicará cuándo realizar los cambios de aceite y las tareas de mantenimiento de acuerdo al tipo de uso, aumentando la rentabilidad operativa.',
          ...
          <li>
            <CamionesCardsCaracteristicaCard
              imagen="/images/camiones/modelos/axor-todo-terreno/datos-tecnicos.jpg"
    ...
    <CamionesExternalLink
      ...
      ctaLink="https://www.mercedes-benz-trucks.com/es_AR/models/axor-todo-terreno.html"
    >
    </CamionesExternalLink>

    <CamionesContactForm modelo="Axor Todo Terreno"></CamionesContactForm>
  </NuxtLayout>
</template>
