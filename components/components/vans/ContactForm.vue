  ...
  <section id="contactForm">
    <div class="pageWidth">
      ...
      <form>
        ...
        <div class="action">
          <button
            :disabled="v$.datos.$dirty || v$.datos.$invalid || !terms"
            class="btn"
...
export default defineComponent({
  ...
  methods: {
    async contact(appConfig: any, url: any) {
      ...
      this.datos.unidad_de_negocio = "vans";
